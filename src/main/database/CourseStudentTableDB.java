...
public class CourseStudentTableDB {
    ...
    private final String MATRIC_NUMBER = "matric_number";
    private final String IMAGE = "image";

    public CourseStudentTableDB(String courseCode) {
        this.TABLE_NAME = courseCode;
        createTable();
    }
